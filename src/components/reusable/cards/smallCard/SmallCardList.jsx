                                    ...
                                    <Draggable draggableId={"key-" + card.id} index={i} key={card.id}>
                                        {(provided, snapshot) => (
                                            <div ref={provided.innerRef}
                                                 className="small-card__list-dnd mb-2"
                                                 {...provided.draggableProps} >
                                                <div className="small-card__list-dnd-btn d-flex align-content-center justify-content-center"
