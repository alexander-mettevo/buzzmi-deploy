...
const HubSubscription = () => {
  ...
  const desktopLayout = (
    <DesktopLayout openers={openers} current={current} setCurrent={setCurrent} descriptionCases={descriptionCases} />
  )
  return (
    <div className="hub">
      <div className="hub__content">
        ...
        <div className="hub__subscription">
          <p className="hub__subscription-text text-center">
            Take your Buzzmi journey to new heights! Upgrade to Premium and access all the best content, tools, and
            perks the app has to offer.
          </p>
          <ResizeComponent
