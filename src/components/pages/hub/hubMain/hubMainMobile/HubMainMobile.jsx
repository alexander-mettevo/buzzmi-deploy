...
import PlanInfo from "../../../../reusable/assets/additionalInformation/items/additionalInformationPlan/items/planInfo/PlanInfo.jsx"
  ...
  return (
    <>
      ...
      <div className="d-flex flex-column align-items-center">
        <Message
          message={
            "Your trial will end in 2 days and your membership will automatically upgraded to <a href='/'>Premium Member</a>"
          }
        />
        <h1 className={"h3 mb-3"}>Rise and shine, Jane!</h1>
